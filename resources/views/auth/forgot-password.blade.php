...
<head>
  ...
  <title>CineTix - Forgot Password</title>
      ...
      <div class="container py-3">
        ...
        <div class="sign-in card mx-auto shadow-lg">
          ...
          <div class="card-body py-8 px-lg-5">
            ...
            <!-- Logo -->
            <a href="{{ route('landing-page') }}" class="mb-5 hstack justify-content-center">
              <img src="{{ asset('assets/images/logos/logo-dark.svg') }}" alt="logo-dark" class="img-fluid" style="max-height: 55px;">
            </a>

            <div class="mb-4 text-center text-secondary" style="font-size: 0.9rem;">
                Lupa password? Tidak masalah. Beritahu kami alamat email Anda, dan kami akan mengirimkan tautan reset password.
            </div>

            <!-- Session Status handled by SweetAlert below -->

            <!-- Form -->
            <form class="d-flex flex-column gap-3" method="POST" action="{{ route('password.email') }}">
              @csrf
