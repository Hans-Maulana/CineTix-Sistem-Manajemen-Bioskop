...
@section('title', 'Edit Promo - ' . $promo->code)
    ...
    <div class="pr-hero mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 position-relative" style="z-index:1;">
            <div>
                ...
                <h1>Edit Promo: {{ $promo->code }}</h1>
                <p class="mb-0" style="opacity:0.85; font-size:0.95rem;">Perbarui detail promo aktif.</p>
            </div>
            <a href="{{ route('admin.promos.show', $promo) }}" class="d-inline-flex align-items-center gap-2 px-4 py-2 rounded-pill text-decoration-none"
               style="background:rgba(255,255,255,0.15); color:#fff; font-weight:600;">
